...
export declare namespace IIndexFund {
    ...
    type StateResponseStructOutput = [BigNumber, BigNumber, BigNumber] & {
...
export declare namespace IndexFundStorage {
    ...
    type ConfigStructOutput = [string, BigNumber, BigNumber] & {
        registrarContract: string;
...
export interface IndexFundInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createIndexFund" | "depositERC20" | "initialize" | "owner" | "queryActiveFundDetails" | "queryConfig" | "queryFundDetails" | "queryInvolvedFunds" | "queryRotatingFunds" | "queryState" | "removeIndexFund" | "removeMember" | "renounceOwnership" | "transferOwnership" | "updateConfig" | "updateFundMembers"): FunctionFragment;
    encodeFunctionData(functionFragment: "createIndexFund", values: [
        string,
        string,
        BigNumberish[],
        boolean,
    ...
    encodeFunctionData(functionFragment: "depositERC20", values: [BigNumberish, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "queryFundDetails", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryInvolvedFunds", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryRotatingFunds", values?: undefined): string;
    encodeFunctionData(functionFragment: "queryState", values?: undefined): string;
    encodeFunctionData(functionFragment: "removeIndexFund", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "removeMember", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
    encodeFunctionData(functionFragment: "transferOwnership", values: [string]): string;
    encodeFunctionData(functionFragment: "updateConfig", values: [string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "updateFundMembers", values: [BigNumberish, BigNumberish[], BigNumberish[]]): string;
    ...
    decodeFunctionResult(functionFragment: "queryRotatingFunds", data: BytesLike): Result;
...
export type ActiveFundUpdatedEventFilter = TypedEventFilter<ActiveFundUpdatedEvent>;
...
export type DonationProcessedEventFilter = TypedEventFilter<DonationProcessedEvent>;
...
export interface IndexFund extends BaseContract {
    ...
    functions: {
        createIndexFund(name: string, description: string, endowments: BigNumberish[], rotatingFund: boolean, splitToLiquid: BigNumberish, expiryTime: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        depositERC20(fundId: BigNumberish, token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        initialize(registrarContract: string, fundRotation: BigNumberish, fundingGoal: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        queryActiveFundDetails(overrides?: CallOverrides): Promise<[IIndexFund.FundResponseStructOutput]>;
        queryConfig(overrides?: CallOverrides): Promise<[IndexFundStorage.ConfigStructOutput]>;
        queryFundDetails(fundId: BigNumberish, overrides?: CallOverrides): Promise<[IIndexFund.FundResponseStructOutput]>;
        queryInvolvedFunds(endowmentId: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        queryRotatingFunds(overrides?: CallOverrides): Promise<[BigNumber[]]>;
        queryState(overrides?: CallOverrides): Promise<[IIndexFund.StateResponseStructOutput]>;
        removeIndexFund(fundId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        removeMember(endowment: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        updateConfig(registrarContract: string, fundRotation: BigNumberish, fundingGoal: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateFundMembers(fundId: BigNumberish, endowmentsAdd: BigNumberish[], endowmentsRemove: BigNumberish[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    createIndexFund(name: string, description: string, endowments: BigNumberish[], rotatingFund: boolean, splitToLiquid: BigNumberish, expiryTime: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        createIndexFund(name: string, description: string, endowments: BigNumberish[], rotatingFund: boolean, splitToLiquid: BigNumberish, expiryTime: BigNumberish, overrides?: CallOverrides): Promise<void>;
        depositERC20(fundId: BigNumberish, token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        initialize(registrarContract: string, fundRotation: BigNumberish, fundingGoal: BigNumberish, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
        queryActiveFundDetails(overrides?: CallOverrides): Promise<IIndexFund.FundResponseStructOutput>;
        queryConfig(overrides?: CallOverrides): Promise<IndexFundStorage.ConfigStructOutput>;
        queryFundDetails(fundId: BigNumberish, overrides?: CallOverrides): Promise<IIndexFund.FundResponseStructOutput>;
        ...
        queryRotatingFunds(overrides?: CallOverrides): Promise<BigNumber[]>;
        queryState(overrides?: CallOverrides): Promise<IIndexFund.StateResponseStructOutput>;
        removeIndexFund(fundId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        removeMember(endowment: BigNumberish, overrides?: CallOverrides): Promise<void>;
        renounceOwnership(overrides?: CallOverrides): Promise<void>;
        transferOwnership(newOwner: string, overrides?: CallOverrides): Promise<void>;
        updateConfig(registrarContract: string, fundRotation: BigNumberish, fundingGoal: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateFundMembers(fundId: BigNumberish, endowmentsAdd: BigNumberish[], endowmentsRemove: BigNumberish[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        "ConfigUpdated(address,uint256,uint256)"(registrarContract?: null, fundingGoal?: null, fundRotation?: null): ConfigUpdatedEventFilter;
        ConfigUpdated(registrarContract?: null, fundingGoal?: null, fundRotation?: null): ConfigUpdatedEventFilter;
        ...
        "Instantiated(address,uint256,uint256)"(registrarContract?: null, fundRotation?: null, fundingGoal?: null): InstantiatedEventFilter;
        Instantiated(registrarContract?: null, fundRotation?: null, fundingGoal?: null): InstantiatedEventFilter;
        "MemberRemoved(uint256,uint32)"(fundId?: null, endowmentId?: null): MemberRemovedEventFilter;
        MemberRemoved(fundId?: null, endowmentId?: null): MemberRemovedEventFilter;
        "MembersUpdated(uint256,uint32[])"(fundId?: null, endowments?: null): MembersUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        queryFundDetails(fundId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        queryInvolvedFunds(endowmentId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        queryRotatingFunds(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        queryFundDetails(fundId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        queryInvolvedFunds(endowmentId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        queryRotatingFunds(overrides?: CallOverrides): Promise<PopulatedTransaction>;
