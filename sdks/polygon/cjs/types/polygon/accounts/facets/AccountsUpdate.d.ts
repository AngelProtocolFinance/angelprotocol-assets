...
export interface AccountsUpdateInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "updateConfig" | "updateDafApprovedEndowments" | "updateOwner"): FunctionFragment;
    encodeFunctionData(functionFragment: "updateConfig", values: [string]): string;
    encodeFunctionData(functionFragment: "updateDafApprovedEndowments", values: [BigNumberish[], BigNumberish[]]): string;
    ...
    decodeFunctionResult(functionFragment: "updateDafApprovedEndowments", data: BytesLike): Result;
...
export interface AccountsUpdate extends BaseContract {
    ...
    functions: {
        updateConfig(newRegistrar: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateDafApprovedEndowments(add: BigNumberish[], remove: BigNumberish[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateOwner(newOwner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    updateConfig(newRegistrar: string, overrides?: Overrides & {
    ...
    callStatic: {
        updateConfig(newRegistrar: string, overrides?: CallOverrides): Promise<void>;
        updateDafApprovedEndowments(add: BigNumberish[], remove: BigNumberish[], overrides?: CallOverrides): Promise<void>;
