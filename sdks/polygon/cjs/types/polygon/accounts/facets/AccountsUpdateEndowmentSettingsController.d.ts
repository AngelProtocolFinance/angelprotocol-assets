...
export declare namespace AccountMessages {
    type UpdateEndowmentControllerRequestStruct = {
        id: BigNumberish;
        settingsController: LibAccounts.SettingsControllerStruct;
    };
    type UpdateEndowmentControllerRequestStructOutput = [
        number,
    ...
    type UpdateEndowmentSettingsRequestStruct = {
        id: BigNumberish;
    ...
    type UpdateEndowmentSettingsRequestStructOutput = [
        number,
        boolean,
        BigNumber,
    ...
    type UpdateFeeSettingRequestStruct = {
        id: BigNumberish;
    ...
    type UpdateFeeSettingRequestStructOutput = [
        number,
...
export interface AccountsUpdateEndowmentSettingsControllerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "updateEndowmentAllowlist" | "updateEndowmentController" | "updateEndowmentSettings" | "updateFeeSettings"): FunctionFragment;
    encodeFunctionData(functionFragment: "updateEndowmentAllowlist", values: [BigNumberish, BigNumberish, string[], string[]]): string;
    encodeFunctionData(functionFragment: "updateEndowmentController", values: [AccountMessages.UpdateEndowmentControllerRequestStruct]): string;
    encodeFunctionData(functionFragment: "updateEndowmentSettings", values: [AccountMessages.UpdateEndowmentSettingsRequestStruct]): string;
    encodeFunctionData(functionFragment: "updateFeeSettings", values: [AccountMessages.UpdateFeeSettingRequestStruct]): string;
    decodeFunctionResult(functionFragment: "updateEndowmentAllowlist", data: BytesLike): Result;
    ...
    getEvent(nameOrSignatureOrTopic: "DafApprovedEndowmentsUpdated"): EventFragment;
...
export type AllowanceUpdatedEventFilter = TypedEventFilter<AllowanceUpdatedEvent>;
...
export type DafApprovedEndowmentsUpdatedEventFilter = TypedEventFilter<DafApprovedEndowmentsUpdatedEvent>;
...
export type DonationMatchCreatedEventFilter = TypedEventFilter<DonationMatchCreatedEvent>;
...
export type EndowmentAllowlistUpdatedEventFilter = TypedEventFilter<EndowmentAllowlistUpdatedEvent>;
...
export type EndowmentDepositEventFilter = TypedEventFilter<EndowmentDepositEvent>;
...
export type EndowmentInvestedEventFilter = TypedEventFilter<EndowmentInvestedEvent>;
...
export type EndowmentRedeemedEventFilter = TypedEventFilter<EndowmentRedeemedEvent>;
...
export type EndowmentUpdatedEventFilter = TypedEventFilter<EndowmentUpdatedEvent>;
...
export type EndowmentWithdrawEventFilter = TypedEventFilter<EndowmentWithdrawEvent>;
...
export type UnexpectedTokensEventFilter = TypedEventFilter<UnexpectedTokensEvent>;
export interface AccountsUpdateEndowmentSettingsController extends BaseContract {
    ...
    functions: {
        updateEndowmentAllowlist(id: BigNumberish, allowlistType: BigNumberish, add: string[], remove: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateEndowmentController(details: AccountMessages.UpdateEndowmentControllerRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateEndowmentSettings(details: AccountMessages.UpdateEndowmentSettingsRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateFeeSettings(details: AccountMessages.UpdateFeeSettingRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    updateEndowmentAllowlist(id: BigNumberish, allowlistType: BigNumberish, add: string[], remove: string[], overrides?: Overrides & {
    ...
    callStatic: {
        updateEndowmentAllowlist(id: BigNumberish, allowlistType: BigNumberish, add: string[], remove: string[], overrides?: CallOverrides): Promise<void>;
        updateEndowmentController(details: AccountMessages.UpdateEndowmentControllerRequestStruct, overrides?: CallOverrides): Promise<void>;
        updateEndowmentSettings(details: AccountMessages.UpdateEndowmentSettingsRequestStruct, overrides?: CallOverrides): Promise<void>;
        updateFeeSettings(details: AccountMessages.UpdateFeeSettingRequestStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "AllowanceSpent(uint256,address,address,uint256)"(endowId?: null, spender?: null, tokenAddress?: null, amount?: null): AllowanceSpentEventFilter;
        AllowanceSpent(endowId?: null, spender?: null, tokenAddress?: null, amount?: null): AllowanceSpentEventFilter;
        "AllowanceUpdated(uint256,address,address,uint256,uint256,uint256)"(endowId?: null, spender?: null, tokenAddress?: null, newBalance?: null, added?: null, deducted?: null): AllowanceUpdatedEventFilter;
        AllowanceUpdated(endowId?: null, spender?: null, tokenAddress?: null, newBalance?: null, added?: null, deducted?: null): AllowanceUpdatedEventFilter;
        "ConfigUpdated()"(): ConfigUpdatedEventFilter;
        ConfigUpdated(): ConfigUpdatedEventFilter;
        "DafApprovedEndowmentsUpdated(uint32[],uint32[])"(add?: null, remove?: null): DafApprovedEndowmentsUpdatedEventFilter;
        DafApprovedEndowmentsUpdated(add?: null, remove?: null): DafApprovedEndowmentsUpdatedEventFilter;
        "DonationMatchCreated(uint256,address)"(endowId?: null, donationMatchContract?: null): DonationMatchCreatedEventFilter;
        DonationMatchCreated(endowId?: null, donationMatchContract?: null): DonationMatchCreatedEventFilter;
        "EndowmentAllowlistUpdated(uint256,uint8,address[],address[])"(endowId?: null, allowlistType?: null, add?: null, remove?: null): EndowmentAllowlistUpdatedEventFilter;
        EndowmentAllowlistUpdated(endowId?: null, allowlistType?: null, add?: null, remove?: null): EndowmentAllowlistUpdatedEventFilter;
        "EndowmentClosed(uint256,((uint32,address),uint8),uint32[])"(endowId?: null, beneficiary?: null, relinked?: null): EndowmentClosedEventFilter;
        EndowmentClosed(endowId?: null, beneficiary?: null, relinked?: null): EndowmentClosedEventFilter;
        "EndowmentCreated(uint256,uint8)"(endowId?: null, endowType?: null): EndowmentCreatedEventFilter;
        EndowmentCreated(endowId?: null, endowType?: null): EndowmentCreatedEventFilter;
        "EndowmentDeposit(uint256,address,uint256,uint256)"(endowId?: null, tokenAddress?: null, amountLocked?: null, amountLiquid?: null): EndowmentDepositEventFilter;
        EndowmentDeposit(endowId?: null, tokenAddress?: null, amountLocked?: null, amountLiquid?: null): EndowmentDepositEventFilter;
        "EndowmentInvested(uint256,bytes4,string,address,uint256,uint256)"(endowId?: null, strategy?: null, network?: null, token?: null, lockAmt?: null, liquidAmt?: null): EndowmentInvestedEventFilter;
        EndowmentInvested(endowId?: null, strategy?: null, network?: null, token?: null, lockAmt?: null, liquidAmt?: null): EndowmentInvestedEventFilter;
        "EndowmentRedeemed(uint256,bytes4,string,address,uint256,uint256)"(endowId?: null, strategy?: null, network?: null, token?: null, lockAmt?: null, liquidAmt?: null): EndowmentRedeemedEventFilter;
        EndowmentRedeemed(endowId?: null, strategy?: null, network?: null, token?: null, lockAmt?: null, liquidAmt?: null): EndowmentRedeemedEventFilter;
        "EndowmentSettingUpdated(uint256,string)"(endowId?: null, setting?: null): EndowmentSettingUpdatedEventFilter;
        EndowmentSettingUpdated(endowId?: null, setting?: null): EndowmentSettingUpdatedEventFilter;
        ...
        "EndowmentWithdraw(uint256,address,uint256,uint8,address,uint32)"(endowId?: null, tokenAddress?: null, amount?: null, accountType?: null, beneficiaryAddress?: null, beneficiaryEndowId?: null): EndowmentWithdrawEventFilter;
        EndowmentWithdraw(endowId?: null, tokenAddress?: null, amount?: null, accountType?: null, beneficiaryAddress?: null, beneficiaryEndowId?: null): EndowmentWithdrawEventFilter;
        "OwnerUpdated(address)"(owner?: null): OwnerUpdatedEventFilter;
        OwnerUpdated(owner?: null): OwnerUpdatedEventFilter;
        "RefundNeeded((string,bytes4,bytes4,uint32[],address,uint256,uint256,uint8))"(arg0?: null): RefundNeededEventFilter;
        RefundNeeded(arg0?: null): RefundNeededEventFilter;
        "TokenSwapped(uint256,uint8,address,uint256,address,uint256)"(endowId?: null, accountType?: null, tokenIn?: null, amountIn?: null, tokenOut?: null, amountOut?: null): TokenSwappedEventFilter;
        TokenSwapped(endowId?: null, accountType?: null, tokenIn?: null, amountIn?: null, tokenOut?: null, amountOut?: null): TokenSwappedEventFilter;
        "UnexpectedTokens((string,bytes4,bytes4,uint32[],address,uint256,uint256,uint8))"(arg0?: null): UnexpectedTokensEventFilter;
