...
export interface AccountsSwapRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "swapToken", values: [
        BigNumberish,
        BigNumberish,
        string,
        BigNumberish,
...
export interface AccountsSwapRouter extends BaseContract {
    ...
    functions: {
        swapToken(id: BigNumberish, accountType: BigNumberish, tokenIn: string, amountIn: BigNumberish, tokenOut: string, slippage: BigNumberish, overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        swapToken(id: BigNumberish, accountType: BigNumberish, tokenIn: string, amountIn: BigNumberish, tokenOut: string, slippage: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
