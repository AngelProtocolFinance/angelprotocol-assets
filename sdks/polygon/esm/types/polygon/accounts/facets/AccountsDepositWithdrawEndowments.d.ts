...
export declare namespace AccountMessages {
    ...
    type DepositRequestStructOutput = [
        number,
        BigNumber,
        BigNumber,
        string
...
export declare namespace IAccountsDepositWithdrawEndowments {
    ...
    type TokenInfoStructOutput = [string, BigNumber] & {
        addr: string;
        amnt: BigNumber;
    };
}
export interface AccountsDepositWithdrawEndowmentsInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "depositERC20" | "depositMatic" | "withdraw"): FunctionFragment;
    encodeFunctionData(functionFragment: "depositERC20", values: [AccountMessages.DepositRequestStruct, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "depositMatic", values: [AccountMessages.DepositRequestStruct]): string;
...
export interface AccountsDepositWithdrawEndowments extends BaseContract {
    ...
    functions: {
        depositERC20(details: AccountMessages.DepositRequestStruct, tokenAddress: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        depositMatic(details: AccountMessages.DepositRequestStruct, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdraw(id: BigNumberish, acctType: BigNumberish, beneficiaryAddress: string, beneficiaryEndowId: BigNumberish, tokens: IAccountsDepositWithdrawEndowments.TokenInfoStruct[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    depositERC20(details: AccountMessages.DepositRequestStruct, tokenAddress: string, amount: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        depositERC20(details: AccountMessages.DepositRequestStruct, tokenAddress: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        depositMatic(details: AccountMessages.DepositRequestStruct, overrides?: CallOverrides): Promise<void>;
        withdraw(id: BigNumberish, acctType: BigNumberish, beneficiaryAddress: string, beneficiaryEndowId: BigNumberish, tokens: IAccountsDepositWithdrawEndowments.TokenInfoStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {
