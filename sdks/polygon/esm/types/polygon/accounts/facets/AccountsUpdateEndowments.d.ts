...
export declare namespace AccountMessages {
    type UpdateEndowmentDetailsRequestStruct = {
        id: BigNumberish;
        owner: string;
        name: string;
        sdgs: BigNumberish[];
    ...
    type UpdateEndowmentDetailsRequestStructOutput = [
        number,
        string,
        string,
        BigNumber[],
...
export interface AccountsUpdateEndowmentsInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "revokeDelegate" | "setDelegate" | "updateAcceptedToken" | "updateEndowmentDetails"): FunctionFragment;
    encodeFunctionData(functionFragment: "revokeDelegate", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setDelegate", values: [BigNumberish, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "updateAcceptedToken", values: [BigNumberish, string, string, boolean]): string;
    encodeFunctionData(functionFragment: "updateEndowmentDetails", values: [AccountMessages.UpdateEndowmentDetailsRequestStruct]): string;
    decodeFunctionResult(functionFragment: "revokeDelegate", data: BytesLike): Result;
...
export interface AccountsUpdateEndowments extends BaseContract {
    ...
    functions: {
        revokeDelegate(id: BigNumberish, setting: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDelegate(id: BigNumberish, setting: BigNumberish, delegateAddress: string, delegateExpiry: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateAcceptedToken(endowId: BigNumberish, tokenAddr: string, priceFeedAddr: string, tokenStatus: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateEndowmentDetails(details: AccountMessages.UpdateEndowmentDetailsRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    revokeDelegate(id: BigNumberish, setting: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        revokeDelegate(id: BigNumberish, setting: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setDelegate(id: BigNumberish, setting: BigNumberish, delegateAddress: string, delegateExpiry: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateAcceptedToken(endowId: BigNumberish, tokenAddr: string, priceFeedAddr: string, tokenStatus: boolean, overrides?: CallOverrides): Promise<void>;
        updateEndowmentDetails(details: AccountMessages.UpdateEndowmentDetailsRequestStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
