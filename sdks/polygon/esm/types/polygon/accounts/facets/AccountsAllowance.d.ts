...
export interface AccountsAllowanceInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "manageAllowances" | "queryAllowance" | "spendAllowance"): FunctionFragment;
    encodeFunctionData(functionFragment: "manageAllowances", values: [BigNumberish, string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "queryAllowance", values: [BigNumberish, string, string]): string;
    encodeFunctionData(functionFragment: "spendAllowance", values: [BigNumberish, string, BigNumberish, string]): string;
    decodeFunctionResult(functionFragment: "manageAllowances", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "queryAllowance", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "spendAllowance", data: BytesLike): Result;
    events: {
...
export interface AccountsAllowance extends BaseContract {
    ...
    functions: {
        manageAllowances(endowId: BigNumberish, spender: string, token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        queryAllowance(endowId: BigNumberish, spender: string, token: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        spendAllowance(endowId: BigNumberish, token: string, amount: BigNumberish, recipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    manageAllowances(endowId: BigNumberish, spender: string, token: string, amount: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        manageAllowances(endowId: BigNumberish, spender: string, token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        queryAllowance(endowId: BigNumberish, spender: string, token: string, overrides?: CallOverrides): Promise<BigNumber>;
        spendAllowance(endowId: BigNumberish, token: string, amount: BigNumberish, recipient: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    populateTransaction: {
        ...
        queryAllowance(endowId: BigNumberish, spender: string, token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        spendAllowance(endowId: BigNumberish, token: string, amount: BigNumberish, recipient: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
    };
