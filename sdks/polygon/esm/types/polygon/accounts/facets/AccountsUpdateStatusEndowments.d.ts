...
export interface AccountsUpdateStatusEndowmentsInterface extends utils.Interface {
    functions: {
        "closeEndowment(uint32,((uint32,address),uint8))": FunctionFragment;
        "forceSetStrategyInactive(uint32,bytes4)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "closeEndowment" | "forceSetStrategyInactive"): FunctionFragment;
    encodeFunctionData(functionFragment: "closeEndowment", values: [BigNumberish, LibAccounts.BeneficiaryStruct]): string;
    encodeFunctionData(functionFragment: "forceSetStrategyInactive", values: [BigNumberish, BytesLike]): string;
    decodeFunctionResult(functionFragment: "closeEndowment", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "forceSetStrategyInactive", data: BytesLike): Result;
    events: {
...
export interface AccountsUpdateStatusEndowments extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AccountsUpdateStatusEndowmentsInterface;
    ...
    functions: {
        closeEndowment(id: BigNumberish, beneficiary: LibAccounts.BeneficiaryStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        forceSetStrategyInactive(id: BigNumberish, strategyId: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    closeEndowment(id: BigNumberish, beneficiary: LibAccounts.BeneficiaryStruct, overrides?: Overrides & {
    ...
    callStatic: {
        closeEndowment(id: BigNumberish, beneficiary: LibAccounts.BeneficiaryStruct, overrides?: CallOverrides): Promise<void>;
        forceSetStrategyInactive(id: BigNumberish, strategyId: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
