...
export declare namespace AccountMessages {
    ...
    type InvestRequestStructOutput = [
        string,
        string,
        BigNumber,
        BigNumber,
    ...
    type RedeemRequestStructOutput = [
        string,
        string,
        BigNumber,
        BigNumber,
    ...
    type RedeemAllRequestStructOutput = [
        string,
        string,
        boolean,
        boolean,
...
export interface AccountsStrategyInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "execute" | "executeWithToken" | "gateway" | "strategyInvest" | "strategyRedeem" | "strategyRedeemAll"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "strategyInvest", values: [BigNumberish, AccountMessages.InvestRequestStruct]): string;
    encodeFunctionData(functionFragment: "strategyRedeem", values: [BigNumberish, AccountMessages.RedeemRequestStruct]): string;
    encodeFunctionData(functionFragment: "strategyRedeemAll", values: [BigNumberish, AccountMessages.RedeemAllRequestStruct]): string;
    decodeFunctionResult(functionFragment: "execute", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "executeWithToken", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "gateway", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "strategyInvest", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "strategyRedeem", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "strategyRedeemAll", data: BytesLike): Result;
    events: {
...
export interface AccountsStrategy extends BaseContract {
    ...
    functions: {
        ...
        strategyInvest(id: BigNumberish, investRequest: AccountMessages.InvestRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        strategyRedeem(id: BigNumberish, redeemRequest: AccountMessages.RedeemRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        strategyRedeemAll(id: BigNumberish, redeemAllRequest: AccountMessages.RedeemAllRequestStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    execute(commandId: BytesLike, sourceChain: string, sourceAddress: string, payload: BytesLike, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        gateway(overrides?: CallOverrides): Promise<string>;
        strategyInvest(id: BigNumberish, investRequest: AccountMessages.InvestRequestStruct, overrides?: CallOverrides): Promise<void>;
        strategyRedeem(id: BigNumberish, redeemRequest: AccountMessages.RedeemRequestStruct, overrides?: CallOverrides): Promise<void>;
        strategyRedeemAll(id: BigNumberish, redeemAllRequest: AccountMessages.RedeemAllRequestStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
