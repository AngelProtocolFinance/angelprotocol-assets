...
export interface ImplementationInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "EMITTER_ADDRESS" | "ENDOWMENT_ID" | "activeOwnersCount" | "addOwners" | "approvalsRequired" | "changeApprovalsRequirement" | "changeRequireExecution" | "changeTransactionExpiry" | "confirmTransaction" | "confirmations" | "executeTransaction" | "getConfirmationCount" | "getConfirmationStatus" | "getOwnerStatus" | "initialize" | "isConfirmed" | "isOwner" | "removeOwners" | "replaceOwner" | "requireExecution" | "revokeConfirmation" | "revokeConfirmationOfFormerOwner" | "submitTransaction" | "supportsInterface" | "transactionCount" | "transactionExpiry" | "transactions"): FunctionFragment;
    encodeFunctionData(functionFragment: "EMITTER_ADDRESS", values?: undefined): string;
    encodeFunctionData(functionFragment: "ENDOWMENT_ID", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "EMITTER_ADDRESS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ENDOWMENT_ID", data: BytesLike): Result;
...
export interface Implementation extends BaseContract {
    ...
    functions: {
        ...
        initialize(_endowmentId: BigNumberish, _emitter: string, _owners: string[], _required: BigNumberish, _requireExecution: boolean, _transactionExpiry: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getConfirmationStatus(transactionId: BigNumberish, ownerAddr: string, overrides?: CallOverrides): Promise<boolean>;
        getOwnerStatus(ownerAddr: string, overrides?: CallOverrides): Promise<boolean>;
        initialize(_endowmentId: BigNumberish, _emitter: string, _owners: string[], _required: BigNumberish, _requireExecution: boolean, _transactionExpiry: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isConfirmed(transactionId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isOwner(arg0: string, overrides?: CallOverrides): Promise<boolean>;
