...
export interface ApTeamInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: "initializeAPTeam", values: [string[], BigNumberish, boolean, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "initializeAPTeam", data: BytesLike): Result;
...
export interface ApTeam extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ApTeamInterface;
    ...
    functions: {
        ...
        initializeAPTeam(owners: string[], _approvalsRequired: BigNumberish, _requireExecution: boolean, _transactionExpiry: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getConfirmationStatus(transactionId: BigNumberish, ownerAddr: string, overrides?: CallOverrides): Promise<boolean>;
        getOwnerStatus(ownerAddr: string, overrides?: CallOverrides): Promise<boolean>;
        initializeAPTeam(owners: string[], _approvalsRequired: BigNumberish, _requireExecution: boolean, _transactionExpiry: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isConfirmed(transactionId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isOwner(arg0: string, overrides?: CallOverrides): Promise<boolean>;
