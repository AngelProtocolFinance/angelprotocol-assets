...
import type { ApTeam, ApTeamInterface } from "../../../polygon/multiSig/ApTeam";
export declare class ApTeam__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "initializeAPTeam";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
    ...
    static createInterface(): ApTeamInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ApTeam;
}
