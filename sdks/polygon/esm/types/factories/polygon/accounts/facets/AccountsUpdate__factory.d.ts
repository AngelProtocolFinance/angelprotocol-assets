...
import type { AccountsUpdate, AccountsUpdateInterface } from "../../../../polygon/accounts/facets/AccountsUpdate";
export declare class AccountsUpdate__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "updateDafApprovedEndowments";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): AccountsUpdate;
}
