...
import type { AccountsAllowance, AccountsAllowanceInterface } from "../../../../polygon/accounts/facets/AccountsAllowance";
export declare class AccountsAllowance__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "manageAllowances";
        ...
        readonly name: "spendAllowance";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }];
    static createInterface(): AccountsAllowanceInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): AccountsAllowance;
}
